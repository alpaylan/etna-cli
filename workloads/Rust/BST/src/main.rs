...
fn run_hegel(property: &str) {
    ...
    let outcome = panic::catch_unwind(AssertUnwindSafe(|| {
        Hegel::new(|tc| {
            ...
            let Some((sample, result)) = bst::strategies::hegel::draw_case(property, &tc) else {
    ...
    match tool {
        "quickcheck" => {
            let result = match property {
                ...
                "InsertUnion" => qc
                    .quicktest(spec::prop_insert_union as fn(Tree, Tree, i32, i32) -> Option<bool>),
                "DeleteInsert" => qc
                ...
                "UnionDeleteInsert" => qc.quicktest(
                ...
                "UnionUnionAssoc" => qc.quicktest(
                    spec::prop_union_union_assoc as fn(Tree, Tree, Tree) -> Option<bool>,
                ),
